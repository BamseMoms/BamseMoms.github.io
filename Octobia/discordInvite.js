var discordInvite = discordInvite || function() {
    ...
    return {
        init: function(e) {
            e.inviteCode = void 0 !== e.inviteCode && e.inviteCode, e.title = void 0 !== e.title ? e.title : "", e.introText = void 0 !== e.introText ? e.introText : "DU HAR BLITT INVITERT.", e.joinText = void 0 !== e.joinText ? e.joinText : "Join", e.joinedText = void 0 !== e.joinedText ? e.joinedText : "Joined", e.width = void 0 !== e.width ? e.width : 400, e.miniMode = void 0 !== e.miniMode && e.miniMode, e.hideIntro = void 0 !== e.hideIntro && e.hideIntro, e.targetElement = void 0 !== e.targetElement ? e.targetElement : "#discordInviteBox", i.inviteCode = e.inviteCode, i.title = e.title, i.introText = e.introText, i.joinText = e.joinText, i.joinedText = e.joinedText, i.miniMode = e.miniMode, i.hideIntro = e.hideIntro, i.width = e.width, i.targetElement = e.targetElement
        },
        render: function() {
            if (window.jQuery) d();
            else {
                ...
                if (discordCode = i.inviteCode, discordCode && "" != discordCode) {
                    ...
                    $(i.targetElement).append(t).attr("version", e), $.ajax({
                        ...
                        error: function(i) {
                            ...
                            var e = null;
                            void 0 !== i.responseJSON ? ($("#buttonText").html(i.responseJSON.message), $("#discordInfo").remove()) : ($("#discordData").remove(), e = !0), e ? $("#introText").html("FEIL: Ugyldig data-URL.") : $("#introText").html("Det har oppstått en feil."), $("#introText").css("margin", 0).show()
                        }
                    })
                } else $(i.targetElement).html("Feil: Ingen invitasjonskode gitt.").attr("id", "discordInviteError").css("display", "inline-block")
            }
        }
    }
}();
